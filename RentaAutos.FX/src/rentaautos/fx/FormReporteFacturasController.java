...
public class FormReporteFacturasController implements Initializable {
    ...
    public void generarReporte() throws ParseException{
        ...
        try {
            ...
            Date FechaInicial = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(getFecha(datePickerFechaInicial) + 
                    " 00:00:00");
            
            Date FechaFinal = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(getFecha(datePickerFechaFinal)+
                    " 23:59:59");
